...
const VISUAL_PALETTE: Array<[string, string]> = [
  ["hsl(214 30% 25%)", "hsl(224 26% 10%)"],
  ["hsl(184 26% 22%)", "hsl(196 24% 9%)"],
  ["hsl(144 22% 21%)", "hsl(158 20% 9%)"],
  ["hsl(284 22% 24%)", "hsl(298 20% 10%)"],
  ["hsl(344 26% 24%)", "hsl(354 22% 10%)"],
  ["hsl(26 26% 23%)", "hsl(18 22% 9%)"],
  ["hsl(250 26% 25%)", "hsl(258 22% 10%)"],
  ["hsl(208 10% 24%)", "hsl(214 10% 9%)"],
];
